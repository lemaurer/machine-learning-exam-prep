...
// Q31 contains two distinct source figures. Keep their storage identities
// separate from earlier HS24 figures while retaining the source Figure 1/2
// labels in the captions shown to the user.
const lloydQuestion = hs24Questions.find((question) => question.number === 31);
if (lloydQuestion) {
  lloydQuestion.figureNumber = 3;
  lloydQuestion.secondFigureNumber = 5;
}
